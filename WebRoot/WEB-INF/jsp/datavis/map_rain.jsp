...
<base href="<%=basePath%>">
  ...
  <!--   <link rel="stylesheet" href="leaflet.css" /> 
	...
	<style>#map { width: 550px; height: 400px; }
		...
		function init1() {
           ...
           //console.info(chartData2)
             ...
             /*for (var i = 0; i<chartData2.length; i++){ 
                if(chartData2[i].rname=='北山镇') bs = chartData2[i].data;
                if(chartData2[i].rname=='黄花镇') hh = chartData2[i].data;
                if(chartData2[i].rname=='金井镇') jj = chartData2[i].data;
                if(chartData2[i].rname=='开慧镇') kh = chartData2[i].data;
                if(chartData2[i].rname=='福临镇') fl = chartData2[i].data;
                if(chartData2[i].rname=='高桥镇') gq = chartData2[i].data;
                if(chartData2[i].rname=='青山铺镇') qsp = chartData2[i].data;
                if(chartData2[i].rname=='安山镇') as = chartData2[i].data;
                if(chartData2[i].rname=='路口镇') lk = chartData2[i].data;
                if(chartData2[i].rname=='果园镇') gy = chartData2[i].data;
       			if(chartData2[i].rname=='黄兴镇') hx = chartData2[i].data;
       			if(chartData2[i].rname=='江背镇') jb = chartData2[i].data;
                if(chartData2[i].rname=='春华镇') ch = chartData2[i].data;
                if(chartData2[i].rname=='长龙街道') cl = chartData2[i].data;
                if(chartData2[i].rname=='星沙街道') xs = chartData2[i].data;
                if(chartData2[i].rname=='湘龙街道') xl = chartData2[i].data;
                if(chartData2[i].rname=='泉塘街道') qt = chartData2[i].data;
                if(chartData2[i].rname=='榔梨街道') ll = chartData2[i].data;
             }*/
