...
<!-- 				<div class="row"> -->
						<div class="col-xs-12">
				<form action="chart5/rainstatistics.do" method="post" name="Form" id="Form">
...
<!-- 	</div> -->
	...
	//var str="";
    if(${pd.chartData5!=''}){
    chartData5 = eval(${pd.chartData5})
    returndata2="[";
    for (var i = 0; i < chartData5.length; i++) {	   
	     if(i!=chartData5.length-1){	                    
	                      returndata2+='"'+chartData5[i].data+'",';	                       	                 
	                   } 
	                   else{	                     
	                     returndata2+='"'+chartData5[i].data+'"';	                    
	                   }	                   
...
// 	alert(1);
	...
	for (var i = 0; i < chartData6.length; i++) {	   
	     if(i!=chartData6.length-1){
	                      returndata1+='"'+chartData6[i].rname+'",';
	                  //    returndata2+='"'+chartData5[i].data+'",';
	                      returndata3+='"'+chartData6[i].time+'",';
 	                    returndata4+='"'+chartData6[i].data+'",';
	                   } 
	                   else{
	                      returndata1+='"'+chartData6[i].rname+'"';
	                  //    returndata2+='"'+chartData5[i].data+'"';
